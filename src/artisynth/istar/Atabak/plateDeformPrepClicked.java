...
public class plateDeformPrepClicked extends AbstractAction {
   ...
   public plateDeformPrepClicked (ReconstructionModel root,
   MechModel mechModel) {
   ...
   public void actionPerformed (ActionEvent evt) {
      ...
      // This is the default
      reconBody
         .setSurfaceMesh (Assist.GetMesh (mechModel, "ReconstructedMandible"));
      ...
      Assist.GetRigidBody (mechModel, "Mandible").setDynamic (Boolean.FALSE);
      ...
      Point3d center =
         Assist.GetRigidBody (mechModel, "Mandible").getCenterOfMass ();
      ...
      int numV = Assist.GetMesh (mechModel, "Mandible").numVertices ();
      ...
      for (int i = 0; i < numV; i++) {
         Vertex3d v = Assist.GetMesh (mechModel, "Mandible").getVertex (i);
      ...
      Vertex3d vertex1 =
         Assist.GetMesh (mechModel, "Mandible").getVertex (idx1);
      ...
      RigidTransform3d initTransform = new RigidTransform3d ();
      initTransform =
         meshHelper
