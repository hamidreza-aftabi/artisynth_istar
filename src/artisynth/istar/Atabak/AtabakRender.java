...
public class AtabakRender extends RootModel {
   ...
   public static class DrawAxes extends DrawBase {
   ...
   public static class DrawLine extends DrawBase {
   ...
   public static class DrawLines extends DrawBase {
   ...
   public static class DrawText extends DrawBase {
