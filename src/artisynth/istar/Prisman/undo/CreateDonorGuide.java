...
import artisynth.istar.Prisman.MandibleReconstruction;
...
public class CreateDonorGuide implements Command {
   ...
   public void execute () {
      ...
      for (int i = 0; i < (2 * root.numberOfSegments); i++) {
         ...
         String path = PathFinder.getSourceRelativePath (MandibleReconstruction.class, "stl/squareFrame.stl");
         ...
         path = PathFinder.getSourceRelativePath (MandibleReconstruction.class, "stl/bladeGuideUnion.stl");
