...
public class TransformTestingClicked extends AbstractAction {
   /**
    * 
    */
   ...
   public TransformTestingClicked (ReconstructionModel root, MechModel mechModel,
   ImprovedFormattedTextField DonorDistanceProx,
   ImprovedFormattedTextField DonorDistanceDis,
   ...
   public void actionPerformed (ActionEvent evt) {
      TestingTransform cmd = new TestingTransform (root, mechModel,
         DonorDistanceProx,
         DonorDistanceDis,
