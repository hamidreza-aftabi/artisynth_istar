...
public class ClipMandCommand implements Command {
   ...
   public void execute () {
      ...
      if (Assist.GetRigidBody (mechModel, "Resection") != null) {
         ...
         RigidBody MandiblePieceLeft = new RigidBody ("Mandible Left");
         MandiblePieceLeft.setSurfaceMesh (MeshParts.get (0));
         mechModel.addRigidBody (MandiblePieceLeft);
         
         RigidBody MandiblePieceRight = new RigidBody ("Mandible Right");
         MandiblePieceRight.setSurfaceMesh (MeshParts.get (1));
         mechModel.addRigidBody (MandiblePieceRight);
        ...
        double volumeResected = Assist.GetRigidBody (mechModel, "Resection").getVolume ();
        System.out.println ("Volume Resected: " + volumeResected + "mm^3");
