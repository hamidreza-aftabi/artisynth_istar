...
import artisynth.istar.Prisman.undo.MaxillaTransform;
...
public class MaxillaTransformButtonClicked extends AbstractAction {
   /**
    * 
    */
   ...
   public MaxillaTransformButtonClicked (ReconstructionModel root, MechModel mechModel,
   ImprovedFormattedTextField DonorDistanceProx,
   ImprovedFormattedTextField DonorDistanceDis,
   ...
   public void actionPerformed (ActionEvent evt) {
      MaxillaTransform cmd = new MaxillaTransform (root, mechModel,
         DonorDistanceProx,
         DonorDistanceDis,
