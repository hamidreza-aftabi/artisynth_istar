...
public class JawReconFemModel extends RootModel {
   ...
   String myGeoDir = PathFinder.getSourceRelativePath (
      JawReconFemModel.class, "geometry/");

   // cut planes between the segments. Meshs are projected onto these planes to
   // ensure that there is no initial interpenetration.
   Plane leftCutPlane =
      new Plane (0.4836247214343, 0.502740247774, 0.71649101326, 36.01393472755);
   Plane midCutPlane =
      new Plane (-0.56041674485, -0.63575106158, -0.530804728478, -3.19762493573);
   Plane rightCutPlane =
      new Plane (-0.64045574825, -0.699644390580, -0.316724109052, 16.5161156723);
