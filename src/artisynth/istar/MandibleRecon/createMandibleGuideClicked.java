...
import artisynth.istar.Prisman.undo.MandibleGuidePrimitiveCommand;
...
//         plane2normal.transform (pose2);
         ...
         String path =
         homeParent
         + "/artisynth_istar/src/artisynth/istar/Prisman/stl/squareFrame30.stl";
         ...
         path =
         homeParent
         + "/artisynth_istar/src/artisynth/istar/Prisman/stl/bladeGuideUnion30.stl";
